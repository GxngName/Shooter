...
health_img = pygame.image.load( "pixilart-drawing (6).png").convert()
meteor_images = []
meteor_list = ['pixilart-drawing (2) (1).png']
           ...
           if event.type == pygame.QUIT:
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_ESCAPE:
                        running = False
        win.fill(menu_color)
        draw_text('Menu', font0, RED, win, 300, 80)
        draw_text('Current score:   000', font1, GREEN, win, 100, 200)
        draw_text('Your best result:   000', font1, GREEN, win, 100, 250)
        draw_text('Your username:   GxngName_mp4', font1, GREEN, win, 100, 300)
        draw_text('Your average score:   000', font1, GREEN, win, 100, 350)
        draw_text('All time best score:   000', font1, GREEN, win, 100, 400)
